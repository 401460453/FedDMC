...
def main():
    ...
    parser.add_argument("--no_env", type=int, default=10, help="the number of edge environment")
    ...
    random.seed(args.no_env)
    np.random.seed(args.no_env)
    print()
    ...
    path_prefix = f'u{args.n_user}c{args.n_class}-alpha{args.alpha}-ratio{args.sampling_ratio}-env{args.no_env}'
